...
async function main() {
  ...
  await prisma.review.createMany({
    data: [
      { authorName: 'Marie L.', authorCity: 'Paris 15e', rating: 5, content: 'Intervention rapide et soignée pour l\'installation de ma pompe à chaleur. Le technicien est très professionnel, ponctuel et explique bien chaque étape. Je recommande vivement !', service: 'Installation PAC', verified: true, published: true, source: 'SITE' },
